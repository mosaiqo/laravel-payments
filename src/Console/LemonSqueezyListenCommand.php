...
namespace Mosaiqo\LaravelPayments\Console;
...
class LemonSqueezyListenCommand extends Command implements Isolatable, PromptsForMissingInput
{
    /**
     ...
     * @var string
     */
    protected $signature = 'payments:listen
    ...
    protected function setupWebhook(string $tunnel): ?int
    {
        ...
        $url = $tunnel.'/'. LaravelPayments::getWebHookPath();
        $data = [
            'data' => [
                'type' => 'webhooks',
                'attributes' => [
